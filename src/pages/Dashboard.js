...
//     try {
//       // Step 1: Request presigned URL from API Gateway (you said PUT returns presigned url)
//       const presignResp = await fetch(API_URL, {
//         method: "PUT", // as you used in Postman
//         headers: {
...
//       // parse JSON (your Lambda should return { uploadURL: "..." } or similar)
//       const presignData = await presignResp.json();
//       // possible key names: uploadURL, uploadUrl, uploadUrl etc. adapt if needed
//       const uploadURL = presignData.uploadURL || presignData.uploadUrl || presignData.uploadUrl || presignData.url || presignData.upload_url;
//       if (!uploadURL) throw new Error("Presigned URL not found in response");

//       // Step 2: PUT file to S3 using the presigned URL
...
//       // Success: add the contract to the list
//       const newContract = {
//         id: Date.now(),
//         name: file.name,
//         date: new Date().toISOString().split("T")[0],
...
//       // you can surface this error in UI (toast / setState). For now:
